...
void moveXAxis(void * parameter){
  for(;;){
      digitalWrite(enablePin, HIGH); // Motor disabled
        ...
        if ((xPosition > 100) && (xPosition < 135)){ // If the motor trigger on their own without touching the joystick it means that the joystick send values lower than 100 and greater than 130 when not touching it, this is a joystick issue, open the gamepad code and monitor the values of the joystick.
